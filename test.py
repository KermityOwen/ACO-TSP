...
for ite in range(iteration):
    ...
    for i in range(m):
        ...
        for j in range(n-1):
            ...
            combine_feature = np.zeros(58)     #intializing combine_feature array to zero
            cum_prob = np.zeros(58)            #intializing cummulative probability array to zeros
